            ...
            <div>
              ...
              <div className="px-6 pt-8 pb-6">
                ...
                <div className="flex flex-col items-center mb-6">
                  <div className="w-32 h-32 rounded-full bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/20 shadow-lg flex items-center justify-center text-4xl font-bold text-primary hover:scale-105 transition-transform duration-300 mb-6">
